...
export default function ContactFile() {
  ...
  return (
    <div className="isolate bg-white px-6 pb-24 py-24 sm:py-32 sm:pb-32 lg:px-8">
      <div
        aria-hidden="true"
          ...
          <div>
            ...
            <div className="mt-2.5">
              <input
                ...
                className="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 outline"
              />
            </div>
          </div>
          <div>
            ...
            <div className="mt-2.5">
              <div className="flex rounded-md bg-white outline-1 -outline-offset-1 outline-gray-300 has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-indigo-600">
                ...
                <input
                  ...
                  className="block min-w-0 grow py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 outline"
                />
              </div>
            </div>
          </div>
